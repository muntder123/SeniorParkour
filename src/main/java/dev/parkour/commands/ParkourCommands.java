...
import dev.parkour.menus.StatsMenu;
import dev.parkour.menus.TopMenu;
...
public class ParkourCommands extends BaseCommand {
    ...
    public void onSetTop(Player player, String map) {
        ...
        Holo hologram = holoManager.createHologram("TopPlayers" + parkourMap.getId(), player.getLocation());
